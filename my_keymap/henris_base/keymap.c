...
[base] = LAYOUT_ergodox_pretty(
    KC_DOT,  KC_1, KC_2, KC_3, KC_4, KC_5, C(A(KC_T)),              KC_NO,  KC_6, KC_7, KC_8, KC_9, KC_0, DE_SS,
    KC_TAB,  KC_Q, KC_W, KC_E, KC_R, KC_T, KC_PSCR,                  KC_NO,  KC_Y, KC_U, KC_I, KC_O, KC_P, DE_UDIA,
